...
public class FlightAverageDelayReducer extends Reducer<OriginDestTuple, DelayTimeAverageTuple, OriginDestTuple, DelayTimeAverageTuple> {

       
    private DelayTimeAverageTuple result = new DelayTimeAverageTuple();

       
	public void reduce(OriginDestTuple key, Iterable<DelayTimeAverageTuple> values,Context context)
