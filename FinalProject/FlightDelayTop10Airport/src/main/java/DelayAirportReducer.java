...
public class DelayAirportReducer extends Reducer<Text, DelayCountRatioTuple, Text, DelayCountRatioTuple> {

    private DelayCountRatioTuple result = new DelayCountRatioTuple();

       
	public void reduce(Text key, Iterable<DelayCountRatioTuple> values,Context context)
